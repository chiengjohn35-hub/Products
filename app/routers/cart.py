...
# Adds an item to a specific cart (Creates cart if id doesn't exist)
...
# Retrieves the full cart and all its items
...
# NEW: Remove a specific product from a specific cart
...
# OPTIONAL: List all carts (Useful for dev/testing)
